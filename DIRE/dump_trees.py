...
import idaapi
import os
import idc  #liujian note

sys.path.append("/usr/local/lib/python3.6/dist-packages")  #liujian note
...
#import os
import re
import idautils    #liujian note
from idc import *  #liujian note
...
#    function_name = GetFunctionName(ea)
    function_name = get_func_name(ea)  #liujian note
    if f is None:
